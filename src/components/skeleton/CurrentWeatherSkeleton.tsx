    ...
    <div className="flex flex-col lg:gap-8 gap-5">
      <div className="flex flex-col items-center rounded-[20px] bg-primary justify-center h-[286px]">
        <div className="flex items-center gap-2.5 mb-3.5">
          <span className="w-3 h-3 rounded-full animate-bouncy-dots delay-0 bg-white/80"></span>
          <span className="w-3 h-3 rounded-full animate-bouncy-dots delay-100 -translate-y-1.5 bg-white/80"></span>
          <span className="w-3 h-3 rounded-full animate-bouncy-dots delay-200 bg-white/80"></span>
        </div>
